...
path = '/home/meg-mri/calibration/'
path = '../calibration'
transforms = dict(np.load(os.path.join(path, 'array120_trans.npz')))

new_names = ['MEG1344', 'MEG1124', 'MEG1244', 'MEG1114',
'MEG1044', 'MEG0724', 'MEG0624', 'MEG0634', 'MEG0424', 'MEG0334',
'MEG0414', 'MEG0234', 'MEG1844', 'MEG1834', 'MEG2244',
'MEG2234', 'MEG2214', 'MEG0744']

for k_old, k_new in zip(list(transforms.keys())[102:], new_names):
    transforms[k_new] = transforms.pop(k_old)
