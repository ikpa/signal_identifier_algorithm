...
<html>
  <head>
    ...
    <title>Visualizing rich datasets: the fire_ug.vtu example &#8212; mayavi 4.7.4 documentation</title>
...
<style type="text/css">
  ...
  .sphinxsidebarwrapper a {
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Visualizing rich datasets: the <code class="docutils literal notranslate"><span class="pre">fire_ug.vtu</span></code> example</a></li> 
      </ul>
    </div>  
  ...
  <section id="visualizing-rich-datasets-the-fire-ug-vtu-example">
