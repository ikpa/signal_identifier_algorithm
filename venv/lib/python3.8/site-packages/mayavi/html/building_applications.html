...
<html>
  <head>
    ...
    <title>Building applications using Mayavi &#8212; mayavi 4.7.4 documentation</title>
...
<style type="text/css">
  ...
  .sphinxsidebarwrapper a {
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-this"><a href="">Building applications using Mayavi</a></li> 
      </ul>
    </div>  
  ...
  <section id="building-applications-using-mayavi">
...
<section id="custom-interactive-dialogs">
...
<section id="embedding-a-mayavi-scene-in-a-traits-dialog">
...
<cite>.configure_traits</cite> method of this object. If a view is explicitly
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">traits.api</span> <span class="kn">import</span> <span class="n">HasTraits</span><span class="p">,</span> <span class="n">Instance</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi.core.ui.mayavi_scene</span> <span class="kn">import</span> <span class="n">MayaviScene</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">tvtk.pyface.api</span> <span class="kn">import</span> <span class="n">Scene</span>
...
<section id="a-scene-with-mlab-embedded">
...
<section id="making-the-visualization-live">
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">numpy</span> <span class="kn">import</span> <span class="n">linspace</span><span class="p">,</span> <span class="n">pi</span><span class="p">,</span> <span class="n">cos</span><span class="p">,</span> <span class="n">sin</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">traits.api</span> <span class="kn">import</span> <span class="n">HasTraits</span><span class="p">,</span> <span class="n">Range</span><span class="p">,</span> <span class="n">Instance</span><span class="p">,</span> \
...
<div class="topic">
<p class="topic-title">Learning by examples</p>
...
<section id="integrating-in-a-wxpython-application">
...
<section id="integrating-in-a-qt-application">
