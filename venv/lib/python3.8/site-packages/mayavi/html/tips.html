...
<html>
  <head>
    ...
    <title>Tips and Tricks &#8212; mayavi 4.7.4 documentation</title>
...
Mayavi2.</p>
<section id="using-mayavi-in-jupyter-notebooks">
...
<section id="off-screen-rendering">
...
<section id="avoiding-the-rendering-window">
...
<section id="rendering-using-the-virtual-framebuffer">
...
<p>If you want to do this in python. You can use <a class="reference external" href="https://pypi.org/project/PyVirtualDisplay/">pyvirtualdisplay</a></p>
...
<span class="n">display</span> <span class="o">=</span> <span class="n">Display</span><span class="p">(</span><span class="n">visible</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span> <span class="n">size</span><span class="o">=</span><span class="p">(</span><span class="mi">1280</span><span class="p">,</span> <span class="mi">1024</span><span class="p">))</span>
...
<a class="reference internal" href="auto/example_offscreen.html#example-offscreen"><span class="std std-ref">Offscreen example</span></a>. This simple example shows how you can use
...
<section id="using-vtk-with-mesa-for-pure-software-rendering">
...
<span class="o">-</span><span class="n">DPYTHON_EXECUTABLE</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="nb">bin</span><span class="o">/</span><span class="n">python2</span><span class="mf">.5</span> \
<span class="o">-</span><span class="n">DPYTHON_LIBRARY</span><span class="o">=/</span><span class="n">usr</span><span class="o">/</span><span class="n">lib</span><span class="o">/</span><span class="n">libpython2</span><span class="mf">.5</span><span class="o">.</span><span class="n">so</span> \
...
<section id="extending-mayavi-with-customizations">
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">mayavi.preferences.api</span> <span class="kn">import</span> <span class="n">preference_manager</span>
<span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">preference_manager</span><span class="o">.</span><span class="n">root</span><span class="o">.</span><span class="n">contrib_packages</span><span class="p">)</span>
<span class="go">[]</span>
...
<section id="customizing-mayavi2">
...
<section id="scripting-mayavi-without-using-envisage">
...
<section id="computing-in-a-thread">
...
<section id="polling-a-file-and-auto-updating-mayavi">
...
<section id="serving-mayavi-on-the-network">
...
<section id="tcp-server-the-serve-tcp-function">
...
<section id="udp-server-the-serve-udp-function">
...
<section id="animating-a-timeseries">
...
<section id="animating-a-visualization">
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">mayavi.tools.animator</span> <span class="kn">import</span> <span class="n">animate</span>
</pre></div>
</div>
...
<section id="creating-a-movie-from-an-animation">
...
<section id="animating-a-series-of-images">
...
<section id="making-movies-from-a-stack-of-images">
...
<section id="scripting-from-the-command-line">
...
<section id="texture-mapping-actors">
...
<section id="shifting-data-and-plotting">
...
<section id="using-the-userdefined-filter">
...
<section id="sharing-the-same-data-between-scenes">
...
<section id="using-the-core-mayavi-api">
...
<section id="changing-the-interaction-with-a-scene">
...
<section id="accelerating-a-mayavi-script">
